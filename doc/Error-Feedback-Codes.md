...
- As of **June 15, 2025**, the error code definitions have been restructured. Some legacy codes from historical versions have been removed, and a more streamlined version has been reorganized and consolidated.
 ...
 | 15 | HERR_UNSUPPORTED | 14 | Requested feature or operation is unsupported (14) |
 ...
 | 27 | HERR_FT_HUB_DISABLE | 201 | FeatureHub is disabled (201) |
 | 28 | HERR_FT_HUB_INSERT_FAILURE | 202 | Data insertion error (202) |
 | 29 | HERR_FT_HUB_NOT_FOUND_FEATURE | 203 | Get face feature error (203) |
 | 30 | HERR_ARCHIVE_LOAD_FAILURE | 251 | Archive load failure (251) |
 | 31 | HERR_ARCHIVE_LOAD_MODEL_FAILURE | 252 | Model load failure (252) |
 | 32 | HERR_ARCHIVE_FILE_FORMAT_ERROR | 253 | The archive format is incorrect (253) |
 | 33 | HERR_ARCHIVE_REPETITION_LOAD | 254 | Do not reload the model (254) |
 | 34 | HERR_ARCHIVE_NOT_LOAD | 255 | Model not loaded (255) |
 | 35 | HERR_DEVICE_CUDA_NOT_SUPPORT | 301 | CUDA not supported (301) |
 | 36 | HERR_DEVICE_CUDA_TENSORRT_NOT_SUPPORT | 302 | CUDA TensorRT not supported (302) |
 | 37 | HERR_DEVICE_CUDA_UNKNOWN_ERROR | 303 | CUDA unknown error (303) |
 | 38 | HERR_DEVICE_CUDA_DISABLE | 304 | CUDA support is disabled (304) |
 | 39 | HERR_EXTENSION_ERROR | 351 | Extension module error (351) |
 | 40 | HERR_EXTENSION_MLMODEL_LOAD_FAILED | 352 | MLModel load failed (352) |
 | 41 | HERR_EXTENSION_HETERO_MODEL_TAG_ERROR | 353 | Incorrect heterogeneous model tag (353) |
 | 42 | HERR_EXTENSION_HETERO_REC_HEAD_CONFIG_ERROR | 354 | Rec head config error (354) |
 | 43 | HERR_EXTENSION_HETERO_MODEL_NOT_MATCH | 355 | Heterogeneous model dimensions do not match (355) |
 | 44 | HERR_EXTENSION_HETERO_MODEL_NOT_LOADED | 356 | Heterogeneous model dimensions not loaded (356) |
