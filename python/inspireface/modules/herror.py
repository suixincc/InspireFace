...
HERR_UNSUPPORTED = 14  # Requested feature or operation is unsupported (14)
...
HERR_FT_HUB_INVALID_FEATURE = 204  # Invalid feature data (204)
HERR_FT_HUB_DATABASE_FAILURE = 205  # Database operation error (205)
